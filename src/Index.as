package
{
   ...
   public class Index extends MovieClip
   {
      ...
      public function Index()
      {
         ...
         this.textTimeTextFormat.size = Math.round(stage.stageWidth / 40 * (4 / 3));
         ...
         this.TextFormat1.size = Math.round(stage.stageWidth / 20 * (4 / 3));
         ...
         this.savevk.x = this.podsave.x - this.podsave.width / 2 + this.podsave.width * (2 / 3);
         ...
         this.savef.x = this.podsave.x - this.podsave.width / 2 + this.podsave.width * (3 / 4);
